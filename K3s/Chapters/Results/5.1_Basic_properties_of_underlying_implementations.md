...
order to start our experiments with kubernetes ingress, Nginx could be considered the initial point of start because it is the easiest to use for a person who holds a basic concept about ingress and wants less stress over configuring. Nginx is also a very reliable ingress controller.
