...
* The user who is requesting the certificaate is stored as part of the CSR resource.

* This CSR remains in a pending state unless and until a cluster admin approves it.
