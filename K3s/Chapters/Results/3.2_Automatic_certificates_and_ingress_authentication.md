...
In thi part of the research qúestion, we focus to generate the certificates automatically using cert-manager in order to ensure a smooth generation and aut-renewal whenever the certificates approcah towards their expiry.
