...
In this part of the research qúestion, we focus to generate the certificates automatically using cert-manager in order to ensure a smooth generation and aut-renewal whenever the certificates approcah towards their expiry.
...
<p>Fig: Wokflow of cert-manager</p>
<p>Source: <a href="https://www.nginx.com/blog/automating-certificate-management-in-a-kubernetes-environment/">Click here</a></p>
